...
import com.zunke.shopmanager.mapper.IntegralMapper;
...
public class IntegralServiceImpl {
    ...
    public Map<String, Object> selectForCount(String name) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("data", this.integralMapper.selectForCount(name));
        return map;
    }
    ...
    public Map<String, Object> selectAll() {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("data", this.integralMapper.selectAll());
        return map;
    }
    ...
    public Map<String, Object> selectById(Integer id) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("data", this.integralMapper.selectById(id));
        return map;
    }
    ...
    public Map<String, Object> selectForPage(int index, int limit, String name) {
        // 获取当前表中的总记录
        int tableCount = this.integralMapper.selectForCount(name);
        ...
        map.put("data", this.integralMapper.selectForPage(index, limit, name));
        return map;
    }
     ...
     * @return 实例对象
     */
    public Map<String, Object> updateById(Integral integral) {
