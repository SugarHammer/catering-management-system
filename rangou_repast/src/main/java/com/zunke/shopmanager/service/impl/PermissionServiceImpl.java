...
import com.zunke.shopmanager.mapper.PermissionMapper;
...
public class PermissionServiceImpl {
    ...
    public Map<String, Object> selectForCount(String name) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("data", this.permissionMapper.selectForCount(name));
        return map;
    }
    ...
    public Map<String, Object> selectAll() {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("data", this.permissionMapper.selectAll());
        return map;
    }
    ...
    public Map<String, Object> selectById(Integer id) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("data", this.permissionMapper.selectById(id));
        return map;
    }
    ...
    // 获取当前表中的总记录
        int tableCount = this.permissionMapper.selectForCount(name);
        ...
        map.put("data", this.permissionMapper.selectForPage(index, name));
        return map;
    }
     ...
     * @return 实例对象
     */
    public Map<String, Object> insert(Permission permission) {
     ...
     * @return 实例对象
     */
    public Map<String, Object> updateById(Permission permission) {
